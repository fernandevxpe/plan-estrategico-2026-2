...
> Slug: `vendas` · Status: **executando** · Responsável: Comercial XPE

Funil comercial, fechamentos, conversão e capacidade da equipe de 2 comerciais.

## Métricas 2026 (YTD)

- Receita: **R$ 1.571.443** (100% do total)
- Contratos fechados: **137**
- Ticket médio: **R$ 11.470**

### Destaques
- 2 comerciais · 9.0 fech./pessoa meta H2
- Pipeline aberto: 676 negócios (R$ 3.406.545)
- Recomendado: 3 comerciais no cenário 2x

## Notas estratégicas

- GATE: nenhum plano extra antes de zerar atraso de orçamentos/propostas — clientes esperando retorno.
- Prioridade #1: avançar 125 neg. em Negociação (~R$ 1,4M) — maior alavanca que lead novo.
- 1º vendedor (ago): entra focado na base pendente + playbook, não prospecção fria.
- 2º vendedor: só se ago+set ≥ R$ 280k/mês combinados E gate de propostas destravado.
- Meta oficial 2026: R$ 3M — jun ainda fecha H1 de R$ 1M.
- Mapear processos → app: checklist, registros, orçamento/proposta automática, PDF e slide por nicho.
- Foco matador visitas: LIE, LDC + planejamento energético, LCC/EV — pós-venda com IA.
- Ritos semanais a formalizar: follow-up, leads, assembleias noturnas, entregas e pós-venda.

## Objetivos

| Objetivo | Métrica | Meta |
| --- | --- | --- |
| Zerar fila de propostas atrasadas | SLA proposta | Nenhum cliente sem retorno > 48h |
| Bater H1 com R$ 1M em receita fechada | Receita H1 | R$ 1.000.000 |
| Meta anual do time comercial | Receita 2026 | R$ 3.000.000 |
| H2 agressivo para sustentar 3M | Receita H2 | R$ 2.000.000 |
| Recuperar conversão dos novos negócios | Conv. novos neg. | ≥ 15% (era 27% em fev) |
| Destravar negociação | Pipeline Negociação | 125 neg. / R$ 1,4M com próximo passo semanal |
| Templates automáticos LIE/LDC/LCC | Proposta automática | PDF + slide por nicho até ago |
| EV como motor de volume | Share EV + pós-venda | ICV/LCC/instalação no H2 |

## Atividades

| Atividade | Responsável | Prazo | Prioridade | Status |
| --- | --- | --- | --- | --- |
| Mapear processo comercial completo (visita → diagnóstico → orçamento → slide → PDF → follow-up) | Diretor + Comercial + Tech | 2026-07 | critical | pendente |
| Ritual semanal de pipeline (segunda) — Negociação + propostas paradas + próximo passo datado | Diretor Comercial | 2026-07 | critical | em_andamento |
| Templates automáticos na ordem LDC → LIE → LCC (PDF + slide) | Diretor + Comercial + Tech | 2026-07 | critical | pendente |
| App de visita: checklist, registros e montagem de orçamento a partir do diagnóstico | Tech + Comercial | 2026-07 | critical | pendente |
| Workshop + ritual semanal (segunda, 1h–2h): dashboard diretor + pauta fixa | Diretor + Gestão | 2026-07 | critical | pendente |
| Dashboard operacional: visitas, propostas, apresentações, SLA 48h — sync Pipedrive | Tech + Diretor | 2026-07 | critical | em_andamento |
| PSEL e contratar 1º vendedor — ramp 0/33/66/100%, foco base Negociação (ago) | Gestão + Diretor | 2026-07 | critical | pendente |
| Templates pós-venda padronizados com personalização por IA | Comercial + Tech | 2026-08 | high | pendente |
| Automação CRM: follow-up 48h pós-proposta + etiqueta obrigatória | Tech + Comercial | 2026-07 | high | em_andamento |
| Campanha comercial EV (ICV, LCC, instalação) | Diretor + Marketing | 2026-08 | high | bloqueada |
| Cenário B: 2º vendedor para out/26 (gatilho ago+set ≥ R$ 280k/mês) | Gestão | 2026-08 | high | bloqueada |
| Checkpoint mensal vs metas 2x/3x com metas por vendedor | Diretor + Gestão | 2026-12 | high | em_andamento |

## Riscos

- **Clientes sem orçamento/proposta — reputação e perda de receita** — mitigação: Gate operacional: nada escala antes de zerar fila. Ritual segunda + SLA 48h.
- **Novo vendedor em prospecção fria ignora R$ 1,4M parados** — mitigação: Onboarding explícito: 1º mês só base + playbook. Diretor acompanha diário.
- **Proposta continua desigual entre vendedores** — mitigação: Templates LIE/LDC/LCC automáticos + app com checklist obrigatório.
- **Ritos semanais não cabem na rotina (assembleias, entregas)** — mitigação: Workshop jul para calendário realista com donos e duração fixa.
- **Meta 3M sem destravar Negociação** — mitigação: Priorizar fechamento do pipeline antes de escalar tráfego ou headcount.

---

## Consultoria

> Slug: `consultoria` · Status: **executando** · Responsável: Operação técnica

Hub de entrega técnica — projetos de engenharia e laudos regulatórios.

## Métricas 2026 (YTD)

- Receita: **R$ 879.884** (56% do total)
- Contratos fechados: **126**
- Ticket médio: **R$ 6.983**

### Destaques
- Projetos: 29 contratos · Laudos: 97 contratos
- 5 projetistas (era 3) + automação
- 56% da receita 2026 YTD

## Notas estratégicas

- Plano em construção — detalhar em conversa com a gestão.
...
> Slug: `consultoria-projetos` · Status: **executando** · Responsável: Projetistas


## Métricas 2026 (YTD)

- Receita: **R$ 162.651** (10,4% do total)
- Contratos fechados: **29**
- Ticket médio: **R$ 5.609**
...
> Slug: `consultoria-laudos` · Status: **executando** · Responsável: Projetistas


## Métricas 2026 (YTD)

- Receita: **R$ 717.233** (45,6% do total)
- Contratos fechados: **97**
- Ticket médio: **R$ 7.394**
...
> Slug: `obras` · Status: **executando** · Responsável: Operação obras


## Métricas 2026 (YTD)

- Receita: **R$ 1.231.528** (78,4% do total)
- Contratos fechados: **60**
- Ticket médio: **R$ 20.525**

### Destaques
- Principal tipo: OBRA (R$ 603.556)
...
> Slug: `marketing` · Status: **executando** · Responsável: Marketing

Tráfego pago, aquisição, conteúdo e geração de demanda qualificada.
...
- Tráfego: R$ 2k/mês jan–mar e R$ 2,5k/mês abr–jun; escalar no H2 conforme cenário 2x/3x.
- Acompanhar CPA por contrato fechado mensalmente.

## Objetivos

| Objetivo | Métrica | Meta |
| --- | --- | --- |
| Executar budget de tráfego H1 | Investimento H1 | R$ 13.500 |
| Manter CPA dentro do benchmark | CPA médio | Monitorar mensal |

## Atividades

| Atividade | Responsável | Prazo | Prioridade | Status |
| --- | --- | --- | --- | --- |
| Calendário de campanhas jul–dez alinhado à sazonalidade | Marketing | 2026-07 | critical | pendente |
| Relatório mensal: investimento × fechamentos × CPA | Marketing | 2026-12 | high | em_andamento |
| Testar criativos para LDC e obras | Marketing | 2026-08 | medium | pendente |

## Riscos

- **CPA subir sem aumento de conversão** — mitigação: Pausar campanhas fracas e realocar para meses de pico.

---

## Eventos

> Slug: `eventos` · Status: **planejando** · Responsável: A definir

Presença em feiras, networking e geração de pipeline presencial.
...
### Destaques
- Sem receita mapeada ainda — área em planejamento
...
> Slug: `smart-charging` · Status: **planejando** · Responsável: Produto EV


## Métricas 2026 (YTD)

- Receita: **R$ 98.803** (6,3% do total)
...
| ICV | 10 | R$ 48.487 |
| LCC | 5 | R$ 27.300 |
| Instalação de Carregador Eletrico | 2 | R$ 23.016 |

---

## Automações e Ferramentas

> Slug: `automacoes-ferramentas` · Status: **executando** · Responsável: Tech / Operações

CRM, ClickUp, automações internas e produtividade da operação.
...
### Destaques
- 1.694 tarefas ClickUp
- 1.771 negócios no Pipedrive
...
> Slug: `medidores-iot` · Status: **estruturando** · Responsável: A definir

Medição, telemetria e produtos conectados para condomínios e clientes.
...
> Slug: `escala` · Status: **planejando** · Responsável: Gestão

Capacidade, contratações, processos e crescimento sustentável da operação.
