...
export function ThemeToggle() {
  ...
  // Evita piscar o ícone errado no primeiro render do servidor antes do
  // useEffect rodar — o círculo aparece (mesmo CSS), só sem ícone dentro por
  // um instante, e fica fora da leitura de teclado/leitor de tela até então.
  if (tema === null) return <button className="theme-toggle" aria-hidden="true" tabIndex={-1} />;
