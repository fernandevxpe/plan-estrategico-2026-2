  ...
  return (
    <div className="presales-page">
      ...
      <section className="presales-grid">
        <article className="presales-panel"><header><strong>Cliques externos × conversas reais</strong><span>{aggregation === "day" ? "Diário" : aggregation === "week" ? "Semanal" : "Mensal"}</span></header><ChartFrame titulo="Pré-vendas — cliques × conversas"><ResponsiveContainer width="100%" height={300}><ComposedChart data={timeline}><CartesianGrid strokeDasharray="3 3" /><XAxis dataKey="label" /><YAxis yAxisId="clicks" /><YAxis yAxisId="chats" orientation="right" /><Tooltip formatter={(value) => integer(Number(value))} /><Bar yAxisId="clicks" dataKey="metaOutboundClicks" name="Cliques externos" fill="#d8b4fe" radius={[4, 4, 0, 0]} /><Line yAxisId="chats" type="monotone" dataKey="contactInitiated" name="Conversas reais" stroke="#059669" strokeWidth={3} /></ComposedChart></ResponsiveContainer></ChartFrame></article>
        <article className="presales-panel"><header><strong>Meta atribuída × Chatwoot confirmado</strong><span>As contagens não são equivalentes</span></header><ChartFrame titulo="Pré-vendas — Meta × Chatwoot"><ResponsiveContainer width="100%" height={300}><ComposedChart data={timeline}><CartesianGrid strokeDasharray="3 3" /><XAxis dataKey="label" /><YAxis /><Tooltip formatter={(value) => integer(Number(value))} /><Bar dataKey="metaConversations" name="Conversas atribuídas Meta" fill="#a78bfa" radius={[4, 4, 0, 0]} /><Line type="monotone" dataKey="contactInitiated" name="Iniciadas no Chatwoot" stroke="#059669" strokeWidth={3} /></ComposedChart></ResponsiveContainer></ChartFrame></article>
      </section>
